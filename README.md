...
When setting up for yourself, change the contents of the mangas list of lists to lists with the format \[Name:str, Link:str, Source:str]. Keep in mind which sources are supported and update LatestChapterRead as needed.
